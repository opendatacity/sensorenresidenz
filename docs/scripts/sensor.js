var Sensor = (function() {
	...
	function D(s, a) { a = a || 0; return new Date(s.valueOf() + a); }
	...
	Sensor.prototype.intervals = function(intervalLength, start) {
		var results, hash = intervalLength + '/' + start;
		if (results = this._cache.interval[hash]) return results;
	...
	Sensor.prototype.statistics = function () {
		...
		result.sums.sort(function (a, b) { return a.value - b.value; });
		return result;
	};
